...
export const SECCION_ZONES: IneZone[] = [
  { left: 0.6, top: 0.44, right: 0.98, bottom: 0.8, scale: 3.6 },
  { left: 0.64, top: 0.48, right: 0.96, bottom: 0.74, scale: 4.2, contrast: true },
  { left: 0.58, top: 0.46, right: 0.95, bottom: 0.82, scale: 3.2 },
  { left: 0.68, top: 0.5, right: 0.96, bottom: 0.72, scale: 4.6 },
  { left: 0.62, top: 0.52, right: 0.94, bottom: 0.78, scale: 3.8, contrast: true },
];
